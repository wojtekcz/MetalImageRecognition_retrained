...
/*
 Old_Polish_Cars_V4 network for recognizing 10 brands of cars that were common on roads of Poland between 1950 and 1990, based on Inception v3.
 
 Inception v3 network was retrained with TensorFlow according to "TensoFlow for poets" tutorial
 https://codelabs.developers.google.com/codelabs/tensorflow-for-poets/#0
 
 Weights and biases for MPSCNNConvolution were converted with
 https://github.com/wojtekcz/MetalCNNWeights

 based on work of kakugawa and Jeff Tang
 https://github.com/kakugawa/MetalCNNWeights
 https://github.com/jeffxtang/MetalCNNWeights
 
 */

let number_of_classes : Int = 10
...
class Inception3Net{
    ...
    let sftid = MPSImageDescriptor(channelFormat: textureFormat, width: 1  , height: 1  , featureChannels: number_of_classes)
    ...
    init(withCommandQueue inputCommandQueue : MTLCommandQueue){
        ...
        fc0 = SlimMPSCNNFullyConnected(kernelWidth: 1,
                                       kernelHeight: 1,
                                       inputFeatureChannels: 2048,
                                       outputFeatureChannels: UInt(number_of_classes),
                                       neuronFilter: nil,
                                       device: device,
    ...
    func getLabel()->String{
        ...
        while( j < 5){
            ...
            if((index < number_of_classes) && (index >= 0)){
    ...
    // these are labels corresponding to output classes
    let labels = [
        "autobus jelcz mzk",
        "autobus jelcz ogórek",
        "fiat 125p",
        "fiat 126p maluch",
        "fsc żuk",
        "fso polonez",
